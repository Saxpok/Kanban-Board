...
import {
  ...
  fetchRepoThunk,
  setStore,
} from "store/slices/getIssuesSlice";
...
const RepoSearch = () => {
  ...
  const getRepoData = async () => {
    ...
    if (!sessionStorage.getItem(request)) {
      ...
      dispatch(
        setStore({
          newStore: JSON.parse(sessionStorage.getItem(request) as string),
        })
      );
    }
  };
  ...
  return (
    <div className="RepoSearch">
      <CustomInput placeHolder={inputMessage} changeHandler={getRequest} />
